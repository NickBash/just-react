    ...
    return (
        <div className="row">
            <div className="col s6 offset-s3">
                <h2 className="center">Сервис сокращения ссылок</h2>
                <div className="card grey lighten-5 z-depth-1">
                        ...
                        <div>
                            ...
                            <div className="input-field">
                                <input id="email" type="text" name="email" value={form.email}
                                       className="validate" placeholder="Введите email" onChange={changeHandler}/>
                                <label htmlFor="email">Email</label>
                            </div>
                            <div className="input-field">
                                <input id="password" type="password" name="password" value={form.password}
                                       className="validate" placeholder="Введите password" onChange={changeHandler}/>
                    ...
                    <div className="card-action">
                        ...
                        <button className="btn blue-4 reg-btn" onClick={registerHandler} disabled={loading}>Регистрация</button>
                    </div>
                </div>
            </div>
        </div>
